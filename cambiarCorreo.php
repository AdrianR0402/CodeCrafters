                            ...
                            <div class="datosUsuario container-border">
                                <div class="container-fluid p-2 text-center">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <h1 class="datosUsuario-header">Cambiar correo</h1>
                                        ...
                                        <div class="col-md-6 text-center mx-auto">
                                            <h1 class="datosUsuario-header">Correo actual</h1>
                                            <p class="datosUsuario-text">correoejemplo@gmail.com</p>
                                            <button type="submit" class="btn btn-primary my-3" alt="Enviar enlace submit">ENVIAR ENLACE PARA
