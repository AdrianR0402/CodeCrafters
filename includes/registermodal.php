...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="/register.php" method="POST">
    <div class="container">
      ...
      <label>
        <input type="checkbox" required name="terms" style="margin-bottom:15px"> I've read and accept the <a href="#"
          style="color:dodgerblue">Terms & Privacy</a>.
      </label>
      <div class="clearfix">
        <button type="button" onclick="document.getElementById('id01').style.display='none';location.href='logout.php'"
