                ...
                <div class="container-fluid mt-5 px-5">
                    <div class="row">
                        <div class="col-md-3 text-center">
                            ...
                            <div class="container">
                                <ul class="list-group">
                                    <li class="list-group-item"><a href="#" class="linksMenu">Información de
                                            Suscripción</a></li>
                                    <li class="list-group-item"><a href="#" class="linksMenu">Preferencias</a></li>
                                    <li class="list-group-item"><a href="#" class="linksMenu">Notificaciones por
                                            correo</a></li>
                                    <li class="list-group-item"><a href="#" class="linksMenu">Cambiar correo</a>
                                    </li>
                                    <li class="list-group-item <?php if ($CURRENT_PAGE == "Password") { ?>active<?php } ?>"><a href="#" class="linksMenu">Cambiar contraseña</a>
                                    </li>
                                    <li class="list-group-item"><a href="#" class="linksMenu">Aplicaciones
                                            conectadas</a></li>
                                </ul>
                            </div>
                        </div>
