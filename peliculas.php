...
<!-- Scrip para que muestre un texto al cargar la pantalla y guardar la cookie -->
    <script>
        ...
        function showCookieAlert() {
            if (!document.cookie.includes("cookie_accepted=true")) {
                ...
                if (userResponse) {
                    setCookie("cookie_accepted", "true", 30); // Establecer la cookie por 30 días (puedes ajustar el valor)
                }
            }
        }
